...
export default function FactCheck() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      console.log(' Raw fact-checks response:', res);
      ...
      if (res && Array.isArray((res as any).data)) {
        ...
        console.log('❌ Is res null?', res === null);
        console.log('❌ Is data array?', Array.isArray((res as any).data));
      }
    })();
            ...
            {selectedClaim.mediaUrl && (
              <div style={{ marginBottom: '16px', display: 'flex', justifyContent: 'center', width: '100%' }}>
                <img
                  ...
                  onError={(e) => {
                    console.error('❌ Image failed to load:', selectedClaim.mediaUrl);
                ...
                />
                <div style={{ fontSize: '11px', color: '#999', marginTop: '8px', wordBreak: 'break-all' }}>
                  {selectedClaim.mediaUrl}
                </div>
              </div>
            )}
